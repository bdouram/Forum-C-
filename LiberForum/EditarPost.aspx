<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarPost.aspx.cs" Inherits="LiberForum.EditarPost" %>
                ...
                <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <label for="comment">Pergunta:</label>
                            ...
                            <div class="row">
                                <asp:LinkButton ID="btnLogin" CssClass="btn btn-primary btn-block btn-lg btn-signin" runat="server" OnClick="btnSalvar_Click" Text ="Alterar"></asp:LinkButton>   
                                <asp:LinkButton ID="LinkButton1" CssClass="btn btn-danger btn-block btn-lg btn-signin" runat="server" OnClientClick = "Confirm()" OnClick="btnApagar_Click" Text ="Apagar"></asp:LinkButton> 
                            </div>
                     </div> 
                </div>
            </div>
